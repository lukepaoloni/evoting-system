...
(async function login() {
  ...
  try {
    ...
    await sleep(1000);
    driver.findElement(By.xpath('//*[@id="root"]/div/div[2]/div/div[4]/div[3]/select/option[2]')).click();
    driver.findElement(By.xpath('//*[@id="root"]/div/div[2]/div/div[5]/div[3]/select/option[3]')).click();

    // driver.findElement(By.id('submitVote')).click();
    await sleep(3000);
